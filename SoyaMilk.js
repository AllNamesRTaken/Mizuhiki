...
(function() {
  ...
  define([], function() {
    'use strict';
    var Expand, Find, Milk, Parse, TemplateCache;
    TemplateCache = {};
    Find = function(name, stack, value) {
      var ctx, hazit, i, part, parts, _i, _j, _len, _ref, _ref1;
      if (value == null) {
        value = null;
      }
      if (name === '.') {
      ...
      for (i = _i = _ref1 = stack.length - 1; _ref1 <= -1 ? _i < -1 : _i > -1; i = _ref1 <= -1 ? ++_i : --_i) {
        ...
        ctx = stack[i];
        if (!(typeof stack[i] === 'object' && (((hazit = ctx.haz !== void 0) && ctx.haz(name)) || name in ctx))) {
          continue;
        }
        value = hazit ? ctx.get(name) : ctx[name];
        break;
      }
        ...
        switch (type) {
          ...
          case '^':
            ...
            sectionInfo['#'] = buildSectionTag = function(name, delims, raw) {
              return function(context) {
                var i, isArray, parsed, result, v, value;
