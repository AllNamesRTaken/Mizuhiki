define [
    ...
    # Javascript.
    #
    # SoyaMilk is Milk wrapped as an AMD module and with the small feature add 
    # of handling {_} inside a loop by replacing it with the index of the loop.
    # This is done to enable binding to individual entries within a loop.
    TemplateCache = {}
    ...
    Parse = (template, delimiters = ['{{','}}'], section = null) ->
      cache = (TemplateCache[delimiters.join(' ')] or= {})
    ...
    Milk =
      ...
      render: (template, data, partials = null) ->
        unless (partials or= @partials or {}) instanceof Function
